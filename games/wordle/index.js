...
function createKeyboard() {
  ...
  let thirdRow = 'Del z x c v b n m Enter';
    ...
    switch (i) {
      case 0:
        ...
        for (let j = 0; j < firstRow.length; j++) {
          ...
          key.innerHTML = firstRow[j];

          rowOne.appendChild(key);
        }

        board.appendChild(rowOne);
        break;
      case 1:
        ...
        for (let j = 0; j < secondRow.length; j++) {
          const key = document.createElement('button');
          key.className = 'keyboard-button';
          key.innerHTML = secondRow[j];

          rowTwo.appendChild(key);
        }

        board.appendChild(rowTwo);
        break;
      case 2:
        const rowThree = document.createElement('div');
        rowThree.className = 'third-row';

        for (let j = 0; j < thirdRow.length; j++) {
          const key = document.createElement('button');
          key.className = 'keyboard-button';
          key.innerHTML = thirdRow[j];

          rowThree.appendChild(key);
        }

        board.appendChild(rowThree);
        break;
    }
  }
}
...
function insertLetter(pressedKey) {
  ...
  let row = document.getElementsByClassName('letter-row')[6 - guesses];
...
function checkGuess() {
  let row = document.getElementsByClassName('letter-row')[6 - guesses];
  let guessString = currentGuess.toString().replace(/,/gi,"")
